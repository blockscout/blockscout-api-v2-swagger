 ...
 * 
 * @export
 * @interface AddressNFTInstance
 */
export interface AddressNFTInstance {
    /**
     * 
     * @type {boolean}
     * @memberof AddressNFTInstance
     */
    isUnique: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the AddressNFTInstance interface.
 */
export function instanceOfAddressNFTInstance(value: object): boolean {
...
export function AddressNFTInstanceFromJSON(json: any): AddressNFTInstance {
    return AddressNFTInstanceFromJSONTyped(json, false);
}

export function AddressNFTInstanceFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddressNFTInstance {
    if (json == null) {
        return json;
    }
    return {
...
export function AddressNFTInstanceToJSON(value?: AddressNFTInstance | null): any {
    if (value == null) {
        return value;
    }
    return {
